export const PageFooter = () => {
  return (
    <div className="pl-[10%]">
      <div className="grid grid-cols-2 xl:grid-cols-4 relative text-white bg-transparent h-full w-full py-5 gap-[2rem] pl-[2rem] "
      ...
      >
        ...
        <div>
          <div className="flex flex-col">
            <p className="text-[16px] xl:text-xl font-bold mb-3">COMPANY</p>
            <p className="text-xs xl:text-[16px]">Donec dignissim</p>
            <p className="text-xs xl:text-[16px]">Curabitur egestas</p>
            <p className="text-xs xl:text-[16px]">Nam posuere</p>
            <p className="text-xs xl:text-[16px]">Aenean facilisis</p>
          </div>
        </div>
        <div>
          <div className="flex flex-col">
