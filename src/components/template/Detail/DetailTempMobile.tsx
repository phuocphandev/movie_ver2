import {
  ...
  export const DetailTempMobile = () => {
    ...
    return (
      <div className="!w-[80vw] pt-10 pb-10 text-white flex-col flex md:hidden gap-10 m-auto ">
        {/* TRAILER */}
        ...
        <div className="flex flex-col gap-4 m-auto">
          <img
            ...
            className="h-[50vh] xl:h-[60vh] rounded-md border border-white "
            alt="..."
          />
          <div className="flex flex-col gap-5 ">
            ...
            {/* MoTa  */}
            <div
              className="flex flex-col gap-5 bg-[#424242] bg-opacity-70 w-[100%]  rounded-xl p-5 mt-5 justify-center m-auto"
              style={{
                boxShadow:
            ...
            >
              ...
              <div className="flex justify-end gap-5 text-xl">
                ...
                <div className="flex text-[#C5CAE9] items-center">
                  <ReadOutlined />
                  <p>Trivia</p>
                </div>
  ...
  export default DetailTempMobile;
